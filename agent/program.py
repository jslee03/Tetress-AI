...
from referee.game.pieces import PieceType
from .board import coords_list, get_possible_actions, remove_line, can_place_piece
...
class Agent:
    ...
    def action(self, **referee: dict) -> Action:
        ...
        # Places the pieces at ranodm until condition is met
        elif turn_count <= RANDOM_THRESHOLD: 
            action = random_move(get_possible_actions(board, coords))

        # Begins game playing algorithm
        else:
